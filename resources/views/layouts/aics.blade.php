...
<div class="topbar">
    ...
    <h5 class="m-0">ASSB Management System - AICS</h5>
</div>
...
<div id="sidebar" class="sidebar text-center">
    ...
    <h6 class="mt-2 mb-0 text-white">{{ Auth::user()->name ?? 'AICS User' }}</h6>
    <small class="text-white-50">Assistant to Individual in Crisis Situation</small>

    <a href="{{ url('/aics/dashboard') }}">🏠 Dashboard</a>
    <a href="{{ url('/aics/records') }}">📋 AICS Records</a>
