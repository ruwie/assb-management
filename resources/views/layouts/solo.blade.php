...
<div class="topbar">
    ...
    <h5 class="m-0">ASSB Management System - Solo Parent</h5>
</div>
...
<div id="sidebar" class="sidebar text-center">
    ...
    <h6 class="mt-2 mb-0 text-white">{{ Auth::user()->name ?? 'Solo Parent User' }}</h6>
    <small class="text-white-50">Solo Parent</small>

    <a href="{{ url('/solo/dashboard') }}">🏠 Dashboard</a>
    <a href="{{ url('/solo/records') }}">📋 Solo Parent Records</a>
